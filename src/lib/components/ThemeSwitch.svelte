...
<button class="btn btn-square btn-ghost hover:bg-transparent text-base-content/75 hover:text-base-content" data-toggle-theme="light,dark" on:click={toggleTheme}>
    <div class="swap swap-rotate {$theme === 'light' ? 'swap-active' : ''}">
        <!-- sun icon -->
