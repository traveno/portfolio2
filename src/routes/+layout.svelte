...
<main class="h-full w-full" id="main-container">
            ...
            <div class="fixed z-10 bg-black/25 backdrop-blur w-full">
                ...
                <div class="navbar md:p-4 md:px-8 z-10">
                    <div class="navbar-start gap-4">
                        ...
                        <div class="tooltip tooltip-bottom hidden md:block" data-tip="Website info">
    ...
    <!-- Background darkness -->
    <!-- <div class="fixed left-0 bottom-0 -z-20 bg-base-100"></div> -->
...
<footer class="flex flex-row justify-between fixed bottom-0 w-full px-8 py-4">
    ...
    <div class="text-sm italic text-base-content/50">
        ...
        <a href="https://threejs.org/" target="_blank" class="text-accent/80">three.js</a>,
        <a href="https://vercel.com/" target="_blank" class="text-accent/80">vercel</a>
    </div>
</footer>
