...
<div class="flex flex-col justify-center items-center">
    <div class="stack shadow-2xl shadow-base-100 flex-1">
        <!-- Card -->
        <div class="p-8 rounded-lg border-2 border-base-content from-transparent/50 to-transparent/20 bg-gradient-to-bl h-72" style:background-color={$heroBackgroundColor}>
            <div class="flex flex-col gap-4 justify-between h-full">
                ...
                <div class="flex flex-row justify-center items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="italic">Take one, done be shy!</p>
                    </div>
                </div>
