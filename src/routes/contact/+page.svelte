...
<div class="w-screen h-screen bg-black">
    <div class="flex flex-col h-screen justify-center items-center">
        <div class="stack shadow-2xl shadow-base-100">
            <!-- Card -->
            <div class="basis-1/3 p-8 rounded-lg border-2 border-base-content from-transparent/50 to-transparent/20 bg-gradient-to-bl h-72" style:background-color={$heroBackgroundColor}>
